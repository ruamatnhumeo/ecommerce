			...
			<section className={filterPanelClass}>
				<div className="filter__panel__content">
					...
					<div className="filter__panel__part">
						...
						<div>
							<ul className="filter__panel__list filter__panel__sort-by-requires">
								<li>
									<input
										type="radio"
										id="bestMatch"
					...
					<div className="filter__panel__part">
						...
						<div>
							<ul className="filter__panel__list filter__panel__sort-by-size">
								<li>
									<input
										type="checkbox"
										id="s"
